...
| Bare metal Intel 10GbE | native zero-copy | **~10.12 M QPS** (X710 single-link, link-bound) · **~20.28 M** dual-link (X510+X710), ~24 % CPU — see [benchmark/INDEX.md](benchmark/INDEX.md) |
