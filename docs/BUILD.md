...
- **`*.minisig`** — [minisign](https://jedisct1.github.io/minisign/) signatures. Every release is signed; verify with the public key below.
...
The signing key is configured, so every release is signed automatically.
