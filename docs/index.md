...
| Page | What you will find |
|------|--------------------|
| [api.md](api.md) | Complete REST API reference — every endpoint, field, and error code (incl. Prometheus `/metrics`, DDoS alert-rules, tarpit, audit tail) |
...
| [security-audit/SECURITY-AUDIT.md](security-audit/SECURITY-AUDIT.md) | Master audit document — all cycles (A through N), current finding statuses, known limitations |
