...
| `latency_p50/95/99_ms` | Latency percentiles from a fixed 15-bucket histogram (zero-alloc); bucket bounds run to 3 s with finer resolution above 1 s (1.5 s / 2 s / 3 s, since 0.9.3) |
