# Runbound v0.23.13 — threadripper-5995wx — X520/82599ES (ixgbe) — `xdp:yes` — 2026-07-03
...
- **Generator (dnsmark):** dragonsage (dual Xeon E5-2690 v2), **dnsmark 2.7.7** + **dnsperf 2.14.0**. AF_XDP generator (`--xdp`), egress NIC X710 i40e. Exact: `dnsmark -s 10.51.10.1 -d /root/queries-A.txt --xdp --ramp` and `… --xdp -Q 0 --max-outstanding 0 -l 20`.
