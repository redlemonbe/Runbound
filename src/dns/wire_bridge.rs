...
//! Transitional bridge between our `wire::Record` and hickory's `Record`.
//!
//! The de-hickory migration flips the zone store to `wire::Record`, but some
//! consumers stay on hickory for good reasons during (and after) the flip — the
