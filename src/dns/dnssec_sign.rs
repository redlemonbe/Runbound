...
//!
//! The key foundation. ECDSA signing runs on `ring`'s
...
//! boundary. RRSIG and NSEC3 layer on top.
//!
...
// ── DNSSEC RRSIG generation (RFC 4034 §3.1, canonical RRset §6) ──
...
// ── DNSSEC NSEC3 hashing + RDATA (RFC 5155, params per RFC 9276) ──
